      ...
      <section className="internal__body">
        <form className="internal__body__form group">
          ...
          {internal.length && !disabled ? (
            <button
              type="submit"
              className="mb-4 flex h-10 group-invalid:hidden w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-blue-900 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-blue-900 focus:bg-blue-900 dark:border-blue-300 dark:bg-blue-900 dark:text-blue-100 dark:hover:bg-slate-900"
